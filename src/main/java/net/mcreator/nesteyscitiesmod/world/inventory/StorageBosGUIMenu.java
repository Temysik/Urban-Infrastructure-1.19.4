...
public class StorageBosGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StorageBosGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(UiModMenus.STORAGE_BOX_GUI.get(), id);
