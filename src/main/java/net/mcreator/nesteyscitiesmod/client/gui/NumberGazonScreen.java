...
import net.mcreator.nesteyscitiesmod.network.NumberGazonButtonMessage;
...
public class NumberGazonScreen extends AbstractContainerScreen<NumberGazonMenu> {
	private final static HashMap<String, Object> guistate = NumberGazonMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	EditBox number_gazon;
	Button button_prodolzhit;
	Button button_na_ghlavnoie_mieniu;

	public NumberGazonScreen(NumberGazonMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("ui:textures/screens/number_gazon.png");

	@Override
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		this.renderBackground(ms);
		super.render(ms, mouseX, mouseY, partialTicks);
		number_gazon.render(ms, mouseX, mouseY, partialTicks);
	...
	public boolean keyPressed(int key, int b, int c) {
		...
		if (number_gazon.isFocused())
			return number_gazon.keyPressed(key, b, c);
	...
	public void init() {
		...
		button_prodolzhit = Button.builder(Component.translatable("gui.ui.number_gazon.button_prodolzhit"), e -> {
			if (true) {
